...
import Finish from "@/pages/Finish/index.js"
  ...
  return (
    <main className="mx-auto flex flex-col justify-center items-center mt-[40px] w-[384px]">
          ...
          <>
            ...
            >
              <div
                className={`${
                  currentIndex >= index
                    ? " relative flex justify-center items-center size-5 rounded-full text-white bg-[#0166FF]"
                    : " flex justify-center items-center bg-grey size-5 rounded-full bg-[#E5E7EB] text-black"
                }`}
              >
                {index + 1}
                ...
                <div>
                  {currentIndex > index ? (
                    <div className=" absolute top-0 translate-y-1/2  h-[4px] w-20 bg-[#0166FF] mt-[8px]" />
                  ) : null}
                </div>
              </div>
      ...
      <Link className="w-full" href={currentIndex === 2 ? "/dashboard" : ""}>
        <button
          className="gap-8 mt-8 bg-[#0166FF] w-full h-[48px] rounded-xl text-white"
          onClick={handleClick}
        >
          {currentIndex === 2 ? "Go To Dashboard" : "Confirm"}
        </button>
      </Link>
    </main>
  );
